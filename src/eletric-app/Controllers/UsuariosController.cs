...
namespace eletric_app.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Email,Nome,Sobrenome,Senha,Perfil")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Email,Nome,Sobrenome,Senha,Perfil")] Usuario usuario)
        {
            if (id != usuario.Email)
            {
                return NotFound();
